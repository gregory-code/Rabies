...
void AEOSGameState::GetCagedCharacters()
{
	TArray<AActor*> FoundActors;
...
void AEOSGameState::Server_NextCharacter_Implementation()
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("Clip board change!"));
	Clipboard->SetNewCharacter(NextCharacter());
}

URCharacterDefination* AEOSGameState::NextCharacter()
{
